...
from services import driver_messages, password_reset_service
...
class PasswordResetSetupView(views.APIView):
    ...
    def post(self, request, format=None):
        ...
        if password_reset:
            driver_messages.password_reset(password_reset)
...
class PasswordResetView(views.APIView):
    ...
    def patch(self, request, format=None):
        ...
        try:
            ...
            password_reset.save()
            driver_messages.password_reset_confirmation(password_reset)
